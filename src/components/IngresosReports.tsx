...
const ANALYSIS_OPTIONS = ['SIBO', 'LACTOSA', 'FRUCTUOSA', 'SIBO C/LACTULON', 'PYLORI', 'EXTRACCION', 'MATERIA FECAL', 'ORINA', 'PANEL 105', 'PANEL 63', 'ALCAT', 'CIBIC', 'CURVA', 'EXTRACCIÓN - ENDOCRINOLOGÍA'];
